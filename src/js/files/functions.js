...
export function addMoney(count, block, delay, delay_off, storrName = 'money') {
	let money = Math.floor(+sessionStorage.getItem(storrName) + count);
	setTimeout(() => {
		sessionStorage.setItem(storrName, money);
